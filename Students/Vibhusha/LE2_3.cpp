...
int main() {
    ...
    if (multiply % 4 ==0 && multiply % 5 == 0 && multiply % 7 == 0) {
        cout << multiply << " is a multiples of 4,5 and 7.";
    }else if( multiply % 4 == 0 && multiply % 5 == 0){
        cout << multiply << " is multiples of both 4 and 5.";
    }else if( multiply % 5  == 0 && multiply % 7 == 0){
        cout << multiply << " is multiples of both 5 and 7.";
    }else if( multiply % 4 == 0 && multiply % 7 == 0){
        cout << multiply << " is multiples of both 4 and 7.";
        ...
        cout<< multiply <<" is not multiples of 3, 4, and 5";
    }
    return 0;
}
